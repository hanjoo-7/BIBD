		...
		imgGalleryView.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
					...
					insimgname.addActionListener(new ActionListener() {
						 public void actionPerformed(ActionEvent e) {
							 ...
							 if (!name.equals("") ) {
			                       ...
			                       imgGalleryDAO.uploadContent(name, path,coupleseq);
						 }
					}			
				});
				}
				// 수정
					...
					uimgname.addActionListener(new ActionListener() {
						 public void actionPerformed(ActionEvent e) {
							 ...
							 uimgname.dispose();
							 imgGalleryDAO.updateimg(name1,name2,coupleseq);
						 }
						 });
						 }
				...
				// 삭제
					...
					delimgname.addActionListener(new ActionListener() {
						 public void actionPerformed(ActionEvent e) {
							 ...
							 delimgname.dispose();
							 imgGalleryDAO.delimg(name,coupleseq);
					 }
				});
				}
				...
				// 조회
					...
					combo = imgGalleryDAO.getlist(coupleseq);
				...
				// 콤보박스
					...
					try {
						...
						selctedimg = imgGalleryDAO.getIMG(value,coupleseq);
